...
define("SERVER_LOGIN", 'paul');
define("SERVER_PASSWORD", 'cookie');



/*
//A sugested layout. Different databases, different user accounts. 
...
define("MYSQL_STORE_DATABASE", "PAW_STORE");
...
//MYSQL_ORDER_DATABASE,ORDER_LOGIN,ORDER_PASSWORD
define("MYSQL_ORDER_DATABASE", "PAW_ORDERS");
define("ORDER_LOGIN","orders");
define("ORDER_PASSWORD","order995");
*/


define("MYSQL_AUTH_DATABASE", "paw");
define("AUTHENTICATOR_LOGIN","pawuser");
define("AUTHENTICATOR_PASSWORD","cookie");

define("MYSQL_CONT_DATABASE", "paw");
define("CONTENT_LOGIN","pawuser");
define("CONTENT_PASSWORD","cookie");

define("MYSQL_STORE_DATABASE", "paw");
define("STORE_LOGIN","pawuser");
define("STORE_PASSWORD","cookie");

define("MYSQL_FORM_DATABASE", "paw");
define("FORM_LOGIN","pawuser");
define("FORM_PASSWORD","cookie");

//MYSQL_ORDER_DATABASE,ORDER_LOGIN,ORDER_PASSWORD
define("MYSQL_ORDER_DATABASE", "paw");
define("ORDER_LOGIN","pawuser");
define("ORDER_PASSWORD","cookie");
...
define("FUNCTION_NAME","[a-zA-Z_]+");
define("FUNCTION_ARGUMENTS","(\([A-Za-z0-9_]*\))*");
