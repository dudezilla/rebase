...
VERSIONING = ("/home/notificationsforsteven/congruencey/"
...
DEFAULT_MODULES = [
    "congruencey", "congruencey-harness", "congruencey-tests",
    "congruencey-bugs", "coverage", "pwdriver",
    "congruencey-bugs/vendor/congruencey",
]
