 ...
 *   - run_verify       runs congruency-tests/verify (the full suite)
 *   - list_bugs        lists the catalogued bugs from congruency-bugs/bugs.json
...
const TOOLS = [
  {
    name: 'run_verify',
    description: 'Run the full congruency verification suite (congruency-tests/verify): PHPUnit, the 15-bug catalog, and branch coverage. Returns the pass/fail summary and output.',
