...
/* BUG-07  Store / order / auth modules reference config constants that
   ...
   execute". Referenced e.g. at:
     vendor/congruencey/.../Catalog/DAO/CatalogDAO.php:39
     vendor/congruencey/.../Order/DAO/OrderDAO.php:8
     vendor/congruencey/lib/UserAuthentication/UserPrivilegeSet.php:27 (ETC)
