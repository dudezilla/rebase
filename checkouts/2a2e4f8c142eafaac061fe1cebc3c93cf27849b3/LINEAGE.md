...
|--------------|-------------------|----------------------------------------------------------|
| `original`   | original source   | pristine congruency (`congruencey-bugs/vendor/congruencey`, the 2006 "old-code") |
| `refactors`  | initial refactors | the resurrected/fixed source at the tournament entry base (`congruencey @ 2a2e4f8c142e`) |
