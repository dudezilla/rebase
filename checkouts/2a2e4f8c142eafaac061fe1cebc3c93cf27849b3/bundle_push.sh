...
REPOS=(congruencey congruencey-harness congruencey-tests congruencey-bugs coverage pwdriver)
...
SUB="$ROOT/congruencey-bugs/vendor/congruencey"
[ -e "$SUB/.git" ] && push_one "$SUB" "vendor-congruencey"
