...
ORIGINAL_REPO="$ROOT/congruencey-bugs/vendor/congruencey"   # pristine original (submodule @ old-code)
SOURCE_REPO="$ROOT/congruencey"                             # tournament source (entry base + my commits)
